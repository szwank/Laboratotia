...
zredukowany_wektor_wartosci_wlasnych = wektor_wartosci_wlasnych;
zredukowana_macierz_wektorow_wlasnych = macierz_wektorow_wlasnych;
...
for i = 1:length(wektor_wartosci_wlasnych)
    ...
    if wektor_wartosci_wlasnych(i) < 1      % Sprawdzenie w którym miejscu wartoœ w³asna jest mniejsz od 1
        ...
        zredukowany_wektor_wartosci_wlasnych(i) = [];           % Uciecie odpowiednich miejsc
        zredukowana_macierz_wektorow_wlasnych(:,i) = [];
    end    
end

...
static void c1_b_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_b_y[2]);
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i8 = 0; c1_i8 < 2; c1_i8++) {
    (*(real_T (*)[2])c1_outData)[c1_i8] = c1_c_y[c1_i8];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3066443404U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2659371505U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3991827918U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(546428326U);
}
...
mxArray *sf_c1_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("wEbdValOKpIhUl14hnaYCH");
...
{
  return "sjLeDf9fqQrZLRq3F0pt6RB";
}
...
static void mdlSetWorkWidths_c1_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3838416952U));
  ssSetChecksum1(S,(654473005U));
  ssSetChecksum2(S,(2693255906U));
  ssSetChecksum3(S,(3588335901U));

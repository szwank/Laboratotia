...
{
  extern unsigned int
    sf_nieLiniowyModelWachadlaOdwruconego_v2_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_nieLiniowyModelWachadlaOdwruconego_v2_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_nieLiniowyModelWachadlaOdwruconego_v2_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "nieLiniowyModelWachadlaOdwruconego_v2") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_nieLiniowyModelWachadlaOdwruconego_v2_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_nieLiniowyModelWachadlaOdwruconego_v2_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "nieLiniowyModelWachadlaOdwruconego_v2") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_nieLiniowyModelWachadlaOdwruconego_v2_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_nieLiniowyModelWachadlaOdwruconego_v2_jit_fallback_info
  ...
  if (strcmp(machineName, "nieLiniowyModelWachadlaOdwruconego_v2") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_nieLiniowyModelWachadlaOdwruconego_v2_jit_fallback_info(nlhs,plhs,
      3,newRhs);
  }
...
{
  extern unsigned int
    sf_nieLiniowyModelWachadlaOdwruconego_v2_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "nieLiniowyModelWachadlaOdwruconego_v2") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_nieLiniowyModelWachadlaOdwruconego_v2_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_nieLiniowyModelWachadlaOdwruconego_v2_get_eml_resolved_functions_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
...
extern unsigned int sf_nieLiniowyModelWachadlaOdwruconego_v2_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"nieLiniowyModelWachadlaOdwruconego_v2")) {
    return(sf_nieLiniowyModelWachadlaOdwruconego_v2_method_dispatcher
...
extern void nieLiniowyModelWachadlaOdwruconego_v2_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    nieLiniowyModelWachadlaOdwruconego_v2_terminator();
...
extern void nieLiniowyModelWachadlaOdwruconego_v2_initializer(void);
extern void nieLiniowyModelWachadlaOdwruconego_v2_register_exported_symbols
  (SimStruct* S);
extern void nieLiniowyModelWachadlaOdwruconego_v2_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  nieLiniowyModelWachadlaOdwruconego_v2_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      nieLiniowyModelWachadlaOdwruconego_v2_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    nieLiniowyModelWachadlaOdwruconego_v2_initializer();
  }

...
static void c1_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_b_y, const char_T *c1_identifier, real_T c1_c_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_b_y[4]);
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_untitled = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c1_untitled", c1_b_u, 1)),
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  for (c1_i6 = 0; c1_i6 < 4; c1_i6++) {
    c1_b_u[c1_i6] = (*(real_T (*)[4])c1_inData)[c1_i6];
  }
  ...
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_b_y[4])
{
  ...
  int32_T c1_i7;
  (void)chartInstance;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_b_u), c1_dv1, 1, 0, 0U, 1, 0U, 1, 4);
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i8 = 0; c1_i8 < 4; c1_i8++) {
    (*(real_T (*)[4])c1_outData)[c1_i8] = c1_c_y[c1_i8];
  }
  ...
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId)
{
  ...
  int32_T c1_i9;
  (void)chartInstance;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_b_u), &c1_i9, 1, 6, 0U, 0, 0U, 0);
  c1_b_y = c1_i9;
  sf_mex_destroy(&c1_b_u);
  return c1_b_y;
}
...
static void init_simulink_io_address(SFc1_untitledInstanceStruct *chartInstance)
{
  chartInstance->c1_u = (real_T (*)[4])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c1_y = (real_T (*)[4])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1356552493U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(493935920U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3579948337U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1242638306U);
}
...
mxArray *sf_c1_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("w6VUKaNneA5j3JOIBMEVaG");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,27);
...
{
  return "sLXKgo3dZH5VxHylUdc1adH";
}
...
static void mdlSetWorkWidths_c1_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2483124147U));
  ssSetChecksum1(S,(4263213493U));
  ssSetChecksum2(S,(3112262779U));
  ssSetChecksum3(S,(1057664692U));

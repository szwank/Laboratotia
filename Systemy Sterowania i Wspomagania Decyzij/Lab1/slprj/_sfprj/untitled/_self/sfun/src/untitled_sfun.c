  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3977736995U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1105617718U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1015490796U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(911529189U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "w6VUKaNneA5j3JOIBMEVaG") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "sLXKgo3dZH5VxHylUdc1adH") == 0) {
